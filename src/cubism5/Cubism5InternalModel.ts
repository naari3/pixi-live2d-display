...
import { Cubism5MotionManager } from "@/cubism5/Cubismt5MotionManager";
...
export class Cubism5InternalModel extends InternalModel {
    ...
    idParamBreath = CubismDefaultParameterId.ParamBreath || "ParamBreath"; // Keep this as fallback
    ...
    protected init() {
        ...
        breathParams.pushBack(new BreathParameterData(CubismFramework.getIdManager().getId(this.idParamAngleX), 0.0, 15.0, 6.5345, 0.5));
        breathParams.pushBack(new BreathParameterData(CubismFramework.getIdManager().getId(this.idParamAngleY), 0.0, 8.0, 3.5345, 0.5));
        breathParams.pushBack(new BreathParameterData(CubismFramework.getIdManager().getId(this.idParamAngleZ), 0.0, 10.0, 5.5345, 0.5));
        breathParams.pushBack(new BreathParameterData(CubismFramework.getIdManager().getId(this.idParamBodyAngleX), 0.0, 4.0, 15.5345, 0.5));
        breathParams.pushBack(new BreathParameterData(CubismFramework.getIdManager().getId(this.idParamBreath), 0.0, 0.5, 3.2345, 0.5));
